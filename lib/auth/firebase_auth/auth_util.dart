...
DocumentReference? get currentUserReference =>
    loggedIn ? AnnouncementsRecord.collection.doc(currentUser!.uid) : null;

AnnouncementsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AnnouncementsRecord.getDocument(
                  AnnouncementsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
